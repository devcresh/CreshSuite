...
local Expansion = { version = COL.version, count = 300 }
COL.AchievementExpansion = Expansion
if COL.RegisterModule then COL:RegisterModule("AchievementExpansion", Expansion) end
...
function A:RecordQuestTurnIn(questID, sourceGame)
    ...
    if COL.BattlePass and COL.BattlePass.AddPassXP then COL.BattlePass:AddPassXP(5, "WoW quest", true) end
    self:EvaluateAll(false)
end
