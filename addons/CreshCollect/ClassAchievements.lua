...
local ClassAchievements = { version = COL.version }
COL.ClassAchievements = ClassAchievements
if COL.RegisterModule then COL:RegisterModule("ClassAchievements", ClassAchievements) end
